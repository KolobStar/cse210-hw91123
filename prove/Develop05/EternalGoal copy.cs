...
public class EternalGoal : Goal
{
    ...
    public EternalGoal(string goalName, string goalDescription, int goalPoints, int
   runningTimes, bool goalComplete) : base(goalName, goalDescription)
    {
    ...
    {
        Console.Write("How many POINTS is this goal worth each time you completeit ? ");
